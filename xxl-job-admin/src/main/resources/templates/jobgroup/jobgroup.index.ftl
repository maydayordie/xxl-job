...
<#macro jobGroupContent>
    <div class="wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="appname form-control" placeholder="${I18n.system_please_input}AppName" >
                        </div>
                    </div>
                    <div class="col-xs-3">
                        <div class="input-group">
                            <span class="input-group-addon">${I18n.jobgroup_field_title}</span>
                            <input type="text" class="title form-control" placeholder="${I18n.jobgroup_field_title}" >
                        </div>
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body">
                                <table class="jobgroup_list table table-bordered table-striped display" width="100%" >
                                    <thead>
                                    <tr>
                                        <th name="id" >ID</th>
        ...
        <!-- 注册列表查看.模态框 -->
        <div class="showRegistryListModal modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="switch-box">
                                        <input type="checkbox" class="groupAlarmFlag switch" name="groupAlarmFlag"/>
                                        <label for="groupAlarmFlag"></label>
                                    </div>
                                </div>
                                <#--groupMessageId-->
                                <div class="groupMessageId" >
