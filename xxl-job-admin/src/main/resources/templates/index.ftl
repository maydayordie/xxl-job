...
<html>
<head>
    <#import "./jobinfo/jobinfo.index.ftl" as jobInfoPage>
    <#import "./joblog/joblog.index.ftl" as jobLogPage>
    <#import "./jobgroup/jobgroup.index.ftl" as jobGroupPage>
    <#import "./user/user.index.ftl" as userPage>
    <#import "./alarm/alarm.index.ftl" as jobAlarmPage>
...
<div class="indexPage page active">
    <div class="wrapper">
        <!-- header -->
...
<div class="jobInfoPage page">
    <@jobInfoPage.jobInfoContent />
</div>

<div class="jobLogPage page">
    <@jobLogPage.jobLogContent />
</div>

<div class="jobGroupPage page">
    <@jobGroupPage.jobGroupContent />
</div>
...
<div class="jobAlarmPage page">
    <@jobAlarmPage.jobAlarmContent />
</div>
